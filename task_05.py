...
# можно Перемешать элементы в списке можно с помощью библиотеки random.
...
# используя список случайных позиций (list_random_index) формирую доп список в которой записываю значения 
# из заданого списка,индексы которых совпадают с сформированным списком случайных позиций
